...
const Contact = () => {
  ...
  return (
    <div>
      <Head>        
        <title>Kontakt - Seed2Success</title>
        <meta charSet="utf-8"/>
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"/>
        <meta name="description" content="Kontakta Seed2Success"/>
        ...
        <div className="container md:px-4 mx-auto">
          <div className="flex flex-wrap mx-4 mb-16 items-center">
            <div className="w-full lg:w-1/2 md:px-4 mb-8 lg:mb-0">
              <div className="max-w-xl">
                <span className="text-lg font-extrabold text-indigo-500 dark:text-green-500">Contact</span>
          ...
          <div className="flex flex-wrap mx-4 mb-16 items-center">
            <div className="w-full lg:w-1/2 md:px-4 mb-16 lg:mb-0">
              <div className="flex flex-wrap mx-4">
                <div className="w-full sm:w-1/2 md:px-4 mb-12">
                  <div className="inline-flex mb-8 w-20 h-20 items-center justify-center bg-white text-indigo-900 dark:text-green-800 border-3 border-indigo-900 dark:border-green-500  rounded-full shadow-md">
            ...
            <div className="w-full lg:w-1/2 md:px-4">
              <div className="px-6 py-12 md:px-12 bg-white dark:bg-gray-900 border-3 border-indigo-900 dark:border-green-500  rounded-2xl shadow-md">
                <form onSubmit={formik.handleSubmit}>
                  <div className="mb-8">
                    ...
                    <input 
                      required 
                      id="email" 
                      className="inline-block w-full p-4 text-lg dark:bg-gray-900 font-extrabold placeholder-indigo-900 dark:placeholder-white shadow dark:shadow-green-800 border-2 border-indigo-900 dark:border-green-500  rounded outline-none" 
                      name="email" 
                      type="email" 
                  ...
                  <div className="mb-8">
                    ...
                    <textarea 
                      required 
                      id="message" 
                      className="w-full p-4 text-lg dark:bg-gray-900 font-extrabold placeholder-indigo-900 dark:placeholder-white shadow dark:shadow-green-800 border-2 border-indigo-900 dark:border-green-500  rounded resize-none" 
                      name="message" 
                      cols="30" 
                      rows="10" 
                  ...
                  <button disabled={formik.isSubmitting} type="submit" className="inline-block w-full py-4 px-6 text-center text-lg leading-6 text-white font-extrabold bg-indigo-800 hover:bg-indigo-900 dark:bg-green-800 dark:hover:bg-green-900 border-3 border-indigo-900 dark:border-green-500  shadow dark:shadow-green-800 rounded transition duration-200">
                    Drop a message
                  </button>
                </form>
              </div>
